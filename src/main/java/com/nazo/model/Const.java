...
public class Const {
  ...
  static {
    ...
    levels.put(LEVEL_4_UUID, new LevelInfo("4", "Wordle", "Wordle！PS：这个是真不会，靠你了！", LEVEL_5_UUID));
    levels.put(LEVEL_5_UUID, new LevelInfo("5", "Color", "10/10。PS: 眼睛都看花了", LEVEL_6_UUID));
    levels.put(LEVEL_6_UUID, new LevelInfo("6", "Number Sequences", "80分通关。PS：0分也是一种水平", LEVEL_7_UUID));
    levels.put(LEVEL_7_UUID, new LevelInfo("7", "Friends", "25/35通关！PS：Friends也是Family", LEVEL_8_UUID));
    levels.put(LEVEL_8_UUID, new LevelInfo("8", "Minecraft", "18/30通关！PS：我的世界玩了好多遍还是没通过关。", LEVEL_9_UUID));
    levels.put(LEVEL_9_UUID, new LevelInfo("9", "Cat", "10/16通关！PS：看过很多布偶的视频，感觉还是它最好摸", LEVEL_10_UUID));
    levels.put(LEVEL_10_UUID, new LevelInfo("10", "Geography", "16/20通关！PS：文科生不得满分？", PUZZLE_1_UUID));
    ...
    levels.put(PUZZLE_4_UUID, new LevelInfo("14", "life", "life", PUZZLE_5_UUID));
    levels.put(PUZZLE_5_UUID, new LevelInfo("15", "brainfuck", "visualizer", CONGRATULATIONS_UUID));
